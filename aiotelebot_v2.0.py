...
async def scheduler():
    # # Мои автосообщения
    # aioschedule.every().day.at("00:10").do(morning_msg)
    # aioschedule.every().day.at("00:12").do(quote_all)
    # aioschedule.every().day.at("04:30").do(quote_all)
    # aioschedule.every().day.at("02:00").do(send_fox)
    # aioschedule.every().day.at("02:10").do(random_eng_word_learn)
    # aioschedule.every().day.at("06:00").do(send_cat)
    # aioschedule.every().day.at("06:30").do(quote_all)
    # aioschedule.every().day.at("07:00").do(random_eng_word_learn)
    # aioschedule.every().day.at("11:00").do(send_fox)
    # aioschedule.every().day.at("15:30").do(evening_msg)
    # aioschedule.every().day.at("15:32").do(send_cat)
    ...
    # aioschedule.every().day.at("01:02").do(quote_all_kris)
    ...
    # aioschedule.every().day.at("09:30").do(random_eng_word_learn_kris)
    # aioschedule.every().day.at("11:30").do(send_fox_kris)
    # aioschedule.every().day.at("16:30").do(evening_msg_kris)
    # aioschedule.every().day.at("16:32").do(quote_all_kris)
    # aioschedule.every().day.at("16:31").do(send_cat_kris)

    # Мои автосообщения
    aioschedule.every().day.at("14:10").do(morning_msg)
    aioschedule.every().day.at("14:12").do(quote_budda)
    aioschedule.every().day.at("18:30").do(quote_all)
    aioschedule.every().day.at("18:00").do(send_fox)
    aioschedule.every().day.at("16:10").do(random_eng_word_learn)
    aioschedule.every().day.at("20:00").do(send_cat)
    aioschedule.every().day.at("20:30").do(quote_all)
    aioschedule.every().day.at("21:00").do(random_eng_word_learn)
    aioschedule.every().day.at("01:00").do(send_fox)
    aioschedule.every().day.at("06:30").do(evening_msg)
    aioschedule.every().day.at("06:32").do(send_cat)
    aioschedule.every().day.at("06:33").do(random_eng_word_learn)
    ...
    aioschedule.every().day.at("10:30").do(send_cat_kris)
    aioschedule.every().day.at("15:00").do(quote_all_kris)
    aioschedule.every().day.at("15:30").do(random_eng_word_learn_kris)
