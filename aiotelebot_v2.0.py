...
async def scheduler():
    ...
    # aioschedule.every().day.at("12:00").do(send_cat)
    # aioschedule.every().day.at("12:30").do(quote_all)
    # aioschedule.every().day.at("13:00").do(random_eng_word_learn)
    # aioschedule.every().day.at("17:00").do(send_fox)
    # aioschedule.every().day.at("22:30").do(evening_msg)
    # aioschedule.every().day.at("22:32").do(send_cat)
    # aioschedule.every().day.at("22:33").do(random_eng_word_learn)
    #
    # # Автосообщения Кристине
